<?php
/**
 * Test: IPub\PhoneUI\PhoneValidation
 * @testCase
 *
...
class PhoneValidationTest extends Tester\TestCase
{
	public function testValidatePhoneWithDefaultCountryWithoutType()
	{
		...
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['BE'])
			->setValue('016123456')
			->validate();
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['NL'])
			->setValue('016123456')
			->validate();
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['BE', 'NL'])
			->setValue('016123456')
			->validate();
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['NL', 'BE'])
			->setValue('016123456')
			->validate();
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['NL', 'DE'])
			->setValue('016123456')
			->validate();
	...
	public function testValidatePhoneWithCountryFieldWithoutType()
	{
		...
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone')
			->setValue('016123456');
	...
	public function testValidatePhoneWithDefaultCountryWithType()
	{
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['BE', 'mobile'])
			->setValue('0499123456')
			->validate();
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['NL', 'mobile'])
			->setValue('0499123456')
			->validate();
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['BE', 'NL', 'mobile'])
			->setValue('0499123456')
			->validate();
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['DE', 'NL', 'mobile'])
			->setValue('0499123456')
			->validate();
	...
	public function testValidatePhoneWithCountryFieldWithType()
	{
		...
		$field = $this->createControls();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['mobile'])
			->setValue('0499123456');
	...
	public function testValidatePhoneAutomaticDetectionFromInternationalInput()
	{
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['AUTO'])
			->setValue('+3216123456')
			->validate();
	...
	public function testValidatePhoneNoDefaultCountryNoCountryField()
	{
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['mobile', 'xyz'])
			->setValue('0499123456')
			->validate();
	}
	...
	public function testValidatePhoneFaultyParameters()
	{
		...
		$field = $this->createControl();
		$field
			->addRule(PhoneUI\Forms\PhoneValidator::PHONE, 'Invalid phone', ['BE', 'mobile', 'xyz'])
			->setValue('016123456')
			->validate();
